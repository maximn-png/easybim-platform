...
export const REPORT_TEMPLATES: ReportTemplate[] = [
  {
    ...
    bodyLines: [
      ...
      'בדיקות אלו נוגעות לאיכות המודלים, ומסייעות להבטיח עבודה מתואמת ומסונכרנת בין היועצים בפרויקט.',
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: 'floor-closure',
        title: 'סגירת תאום מערכות פר קומה',
        bodyLines: [
          'שלום לכולם,',
          'מצורפים תכניות ודוח תיאום מערכות סופי עבור קומות [למלא סוג קומות] בפרויקט {project}.',
          'כלל החומר זמין לעיונכם בענן Forma, {{modelLink}}.',
          'לאחר כ-[X] שבועות של עבודה משותפת עם הצוות, נותרו מספר הערות פתוחות. מבחינתנו, המשך הטיפול בהערות אלו נמצא כעת באחריותם הבלעדית של המתכננים. עם השלמת הטיפול מצידם, קומות אלו יוגדרו כמתואמות.',
          'לתשומת ליבכם, כל שינוי עתידי בתכנון בקומות אלו יש להעביר אלינו במייל כשהוא מסומן ב"עננים", על מנת שנוכל לבצע בדיקת תיאום מערכות חוזרת באופן יעיל.',
          'בברכה,',
        ],
        linkKinds: ['model'],
