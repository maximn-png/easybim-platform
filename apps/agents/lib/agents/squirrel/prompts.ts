...
export const SETUP_SYSTEM = [
  ...
  `2. קרא ל-setup_project עם ה-itemId. המבנה שטוח: הכלי יוצר את "<מספר הצעה> - <שם נקי>" ישירות תחת תיקיית השורש Price Quotes (אין שכבת לקוחות), עם כל האינסטלציה (3 תיקיות, תבנית TYPE C - תכנון עבודה, _meta, קבצים מ-Monday), כותב קישורים ומודיע.`,
  `3. אם setup_project החזיר SKIP (לא סוג C / אין מספר הצעה) — עצור והסבר מה חסר.`,
  ...
  `5. החזר שורת סיכום קצרה על סמך תוצאת setup_project בפועל: שם הפרויקט, מספר הקבצים, וקישור התיקייה האמיתי (folderUrl שחזר). אם ההקמה לא בוצעה (SKIP/שגיאה), דווח זאת בכנות ואל תתאר תוצאה שלא קרתה.`,
  '',
  QUOTE_STRUCTURE,
  '',
