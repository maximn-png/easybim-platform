...
- סטטוסים: טיוטה שסיימת → "pending_approval" (ממתין לאישור מקסים). מקסים מאשר → "approved"/"ready_to_publish". ביקש שינויים → "revise". לעולם אל תסמן "published" — מקסים מפרסם בלינקדאין ידנית ומסמן בעצמו.
