...
- טיוטה מוכנה: העבר ל-Status="pending_approval" (ממתין לאישור מקסים). "approved"/"ready_to_publish"/"scheduled" הן החלטות של מקסים, ו-"published" נקבע ידנית אחרי פרסום בלינקדאין.
